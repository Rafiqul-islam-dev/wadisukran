...
const { agents, wins, all_agents, filters } = defineProps<{
    agents: Array<any>
    wins: any
    products: Array<any>
    all_agents: Array<any>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 p-3">
                                ...
                                <div class="bg-white rounded-2xl shadow-lg">
                                    <div class="grid grid-cols-2 md:grid-cols-6 gap-4 p-3 mb-2 items-center">
                                        <div class="group">
                                            ...
                                            <Multiselect v-model="form.agent" :options="all_agents" valueProp="id"
                                                label="name" placeholder="Agent..." :searchable="true" class="w-full" />
                                        ...
                                        <div class="group">
                                            <label class="block text-sm font-medium text-gray-700 mb-3">From
                                                Date</label>
                                ...
                                <div v-else
                                    class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 mt-4">
                                    ...
                                    <div class="overflow-x-auto">
                                        ...
                                        <!-- pagination -->
                                        <div v-if="wins?.links && wins?.data?.length"
                                            class="mt-4 flex justify-end py-5 px-6">
                        ...
                        <div v-else class="overflow-x-auto">
                            ...
                            <div v-if="modalLinks?.length" class="mt-4 flex justify-end">
                                <nav class="flex items-center gap-1">
                                    <button v-for="(link, i) in modalLinks" :key="i"
                                        @click="link.url && fetchModalData(link.url)" v-html="link.label"
