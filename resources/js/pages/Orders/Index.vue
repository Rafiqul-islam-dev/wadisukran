...
const filteredOrders = computed(() => {
    return orders.filter((order: any) => {
        ...
        const matchesUser = filter.value.user_id
            ? order.user_id === parseInt(filter.value.user_id)
            : true;
...
const getBigPrize = (order: any) => {
    const numberPrizes: Record<string, string> = {
        ...
        <div class="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="text-sm text-gray-500">
                    Total Orders:
                    <span class="font-semibold text-gray-700">{{ filteredOrders.length }}</span>
                </div>
            </div>
            ...
            <Teleport to="body">
                <div v-if="showModal" class="fixed inset-0 z-50 overflow-y-auto" @click.self="closeModal">
                    <div
                        ...
                        :class="modalVisible ? 'opacity-50' : 'opacity-0'"
                    ></div>
                                ...
                                <div v-if="selectedOrder" class="p-8">
                                    ...
                                    <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 mb-8">
                                        ...
                                        <div class="flex justify-center mb-6">
                                            <div
                                                class="w-32 h-32 bg-white rounded-2xl shadow-lg overflow-hidden"
                                            >
                                                <img
                                                    v-if="selectedOrder.product.image_url"
                                        ...
                                        <div
                                            v-for="(card, index) in selectedOrder.game_cards"
                                            :key="index"
                                            class="mb-6"
                                        >
                                            <div class="bg-white rounded-xl p-6 shadow-md">
                                                <h4
                                                    class="font-bold text-lg mb-4 text-center text-gray-800"
                                                >
                                                    Card {{ index + 1 }}
                                                </h4>
                                                <div class="mb-6">
                                                    <h5
                                                        class="font-semibold text-center mb-3 text-gray-700"
                                                    >
                                                        Selected Numbers
                                                    </h5>
                                                    <div class="flex justify-center gap-3 flex-wrap">
                                                        <div
                                                            v-for="n in card.selected_numbers"
                                                            :key="n"
                                                ...
                                                >
                                                    <div class="text-center p-3 bg-green-50 rounded-lg">
                                                        <h5
                                                            class="font-semibold text-green-800 mb-1"
                                                        >
                                                            Straight
                                                        </h5>
                                                        <p
                                                    ...
                                                    <div class="text-center p-3 bg-purple-50 rounded-lg">
                                                        <h5
                                                            class="font-semibold text-purple-800 mb-1"
                                                        >
                                                            Chance
                                                        </h5>
                                                        <p
                                    ...
                                    >
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                            <div>
                                                <svg
                                                    class="w-5 h-5 mx-auto mb-2 text-blue-400"
                                                    fill="none"
                                                    stroke="currentColor"
                                                    viewBox="0 0 24 24"
                                                >
